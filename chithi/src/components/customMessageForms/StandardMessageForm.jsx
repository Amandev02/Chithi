...
const StandardMessageForm  = ({props, activeChat }) =>{
 ...
 const handleSubmit = async () => {
    ...
    const form = {attachment: at, created : date, sender_username : props.username, text : message, activeChatId: activeChat.id, }
  ...
  return (
    <div className = 'message-form-container'>{ preview && (
      <div className='message-form-privew'>
